...
export const content = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: "BRISA",
      sector: "Inmobiliario",
      tagline: "Claridad y confianza antes del primer contacto.",
      status: "Proyecto en desarrollo",
      problem:
        "Definir cómo presentar un proyecto inmobiliario de Puerto Escondido y facilitar la conversación con personas interesadas.",
      solution:
        "Una propuesta de arquitectura web y captación informada por investigación de mercado y auditoría de conversión.",
      components: [
        "Auditoría de conversión e investigación de mercado",
        "Propuesta de arquitectura web",
        "Dirección visual inmobiliaria",
        "Estructura multilingüe",
        "Creativos y sistema de captación",
      ],
      image: "",
      imageAlt: "",
      url: "",
    ...
    },
    {
      ...
      problem:
        "Facilitar la consulta de productos de mayoreo y llevar una selección ordenada a una cotización por WhatsApp.",
      solution:
        "Catálogo digital adaptable a móvil, conectado con datos de Google Sheets y un flujo de selección, cotización y pedido.",
      components: [
        "Catálogo digital de mayoreo",
        "Datos conectados desde Google Sheets",
    ...
    {
      id: "laboratorio-educativo",
      title: "Laboratorio de Diseño Educativo con IA",
      sector: "Educación",
      tagline: "La IA se entiende mejor cuando tiene contexto.",
      status: "Diseño conceptual",
      problem:
        "Conectar el aprendizaje de inteligencia artificial con situaciones cotidianas y necesidades reales de docentes.",
      solution:
        "Diseño conceptual de una plataforma de aprendizaje con recursos, cursos y una arquitectura de módulos, facilitadores y sesiones.",
      components: [
        "Diseño conceptual de plataforma de aprendizaje",
        "Recursos y cursos para docentes",
        "Explicaciones conectadas con contextos cotidianos",
        "Arquitectura de módulos, facilitadores y sesiones",
        "IA aplicada a necesidades educativas reales",
      ],
      image: "",
      imageAlt: "",
      url: "",
